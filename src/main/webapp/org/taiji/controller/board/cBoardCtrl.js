/**
 * Created by fengqy on 2018/12/18.
 */
cBoard.controller('cBoardCtrl', function ($rootScope, $scope, $location, $http, $q, $filter, $uibModal, ModalUtils) {
    ...
    $scope.isSon = function (menu,soneMenu) {
        if(soneMenu.parentId==menu.menuId){
            return true
        }else{
            return false;
        }
    ...
    $scope.changePwd = function () {
        $uibModal.open({
            templateUrl: 'org/taiji/view/taiji/changePwd.html',
