...
// };
        ...
        $scope.getChartView = function () {
            if ($scope.curWidget.config && $scope.curWidget.config.chart_type) {
                return 'org/taiji/view/config/chart/' + $scope.curWidget.config.chart_type + '.html';
            }
        };

        $scope.getOptionsView = function () {
            var basePath = 'org/taiji/view/config/chart/options/';
            if ($scope.curWidget.config && $scope.curWidget.config.chart_type) {
        ...
        $scope.editFilter = function (setbackArr, setbackIdx) {
            $uibModal.open({
                templateUrl: 'org/taiji/view/dashboard/modal/param.html',
                windowTemplateUrl: 'org/taiji/view/util/modal/window.html',
                backdrop: false,
                size: 'lg',
                resolve: {
        ...
        $scope.editVFilter = function (o) {
            $uibModal.open({
                templateUrl: 'org/taiji/view/config/modal/vfilter.html',
                windowTemplateUrl: 'org/taiji/view/util/modal/window.html',
                backdrop: false,
                size: 'lg',
                controller: function ($scope, $uibModalInstance) {
