var rstCityApp = angular.module('rstCityApp', []);
...
rstCityApp.controller('rstCityAppCtrl', function ($scope, $http, $interval, $filter,$location) {
    $scope.city= $location.search().city;
    $scope.loadGjxxList = function () {
        var pageNum = 1;
        var pageSize = 5;
        var city=$scope.city;
        $http.post("rst/city/listGjxx.do", {city:city,pageNum: pageNum, pageSize: pageSize}).success(function (response) {
    ...
    $scope.loadTableChange = function () {
        ...
        var pageNum = 1;
        var pageSize = 7;
        $http.post("rst/city/listTableChange.do", {city:$scope.city,pageNum: pageNum, pageSize: pageSize}).success(function (response) {
            var data = [];
            var xData = [];
